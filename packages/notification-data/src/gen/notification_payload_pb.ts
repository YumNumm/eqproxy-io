...
// @generated from file notification_payload.proto (package eqmonitor, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum eqmonitor.JmaIntensity
 */
...
// Retrieve enum metadata with: proto3.getEnumType(JmaIntensity)
proto3.util.setEnumType(JmaIntensity, "eqmonitor.JmaIntensity", [
...
/**
 * @generated from message eqmonitor.NotificationPayload
 */
export class NotificationPayload extends Message<NotificationPayload> {
  ...
  /**
   * @generated from field: eqmonitor.NotificationPayload.Type type = 2;
   */
  type = NotificationPayload_Type.UNSPECIFIED;

  /**
   * @generated from oneof eqmonitor.NotificationPayload.information
   */
  information: {
    /**
     * @generated from field: eqmonitor.NotificationPayload.EewInformation eew_information = 3;
     */
    value: NotificationPayload_EewInformation;
    case: "eewInformation";
  } | {
    /**
     * @generated from field: eqmonitor.NotificationPayload.EarthquakeInformation earthquake_information = 4;
     */
  ...
  static readonly typeName = "eqmonitor.NotificationPayload";
...
/**
 * @generated from enum eqmonitor.NotificationPayload.Type
 */
...
proto3.util.setEnumType(NotificationPayload_Type, "eqmonitor.NotificationPayload.Type", [
...
/**
 * @generated from message eqmonitor.NotificationPayload.EewInformation
 */
export class NotificationPayload_EewInformation extends Message<NotificationPayload_EewInformation> {
  /**
   * @generated from field: eqmonitor.NotificationPayload.HypoInformation hypo_information = 1;
   */
  hypoInformation?: NotificationPayload_HypoInformation;

  /**
   * @generated from field: optional eqmonitor.JmaIntensity max_intensity = 2;
   */
  maxIntensity?: JmaIntensity;

  /**
   * @generated from field: repeated eqmonitor.NotificationPayload.EewRegionIntensity region_intensities = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "eqmonitor.NotificationPayload.EewInformation";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "hypo_information", kind: "message", T: NotificationPayload_HypoInformation },
    { no: 2, name: "max_intensity", kind: "enum", T: proto3.getEnumType(JmaIntensity), opt: true },
...
/**
 * @generated from message eqmonitor.NotificationPayload.EarthquakeInformation
 */
export class NotificationPayload_EarthquakeInformation extends Message<NotificationPayload_EarthquakeInformation> {
  ...
  /**
   * @generated from field: repeated eqmonitor.NotificationPayload.RegionIntensity region_intensities = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "eqmonitor.NotificationPayload.EarthquakeInformation";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "hypo_information", kind: "message", T: NotificationPayload_HypoInformation },
    { no: 2, name: "max_intensity", kind: "enum", T: proto3.getEnumType(JmaIntensity), opt: true },
...
/**
 * @generated from message eqmonitor.NotificationPayload.RegionIntensity
 */
export class NotificationPayload_RegionIntensity extends Message<NotificationPayload_RegionIntensity> {
  ...
  /**
   * @generated from field: eqmonitor.JmaIntensity intensity = 2;
   */
  intensity = JmaIntensity.JMA_INTENSITY_UNSPECIFIED;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "eqmonitor.NotificationPayload.RegionIntensity";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "code", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "intensity", kind: "enum", T: proto3.getEnumType(JmaIntensity) },
  ]);
...
/**
 * @generated from message eqmonitor.NotificationPayload.EewRegionIntensity
 */
export class NotificationPayload_EewRegionIntensity extends Message<NotificationPayload_EewRegionIntensity> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "eqmonitor.NotificationPayload.EewRegionIntensity";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "code", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "intensity", kind: "enum", T: proto3.getEnumType(JmaIntensity) },
...
/**
 * @generated from message eqmonitor.NotificationPayload.HypoInformation
 */
export class NotificationPayload_HypoInformation extends Message<NotificationPayload_HypoInformation> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "eqmonitor.NotificationPayload.HypoInformation";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
